...
<div class="modal fade" id="users_registry" role="dialog">
...
<div class="modal fade" id="admin_users_registry" role="dialog">
    <div class="modal-dialog">
        <form method="POST" action="../../../lib/php/admin_user_registry.php" name="comp">
            <!-- Contenido del modal-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h2 align="center">INGRESAR DATOS DEL CLIENTE</h2>
                </div>
                <div class="modal-body" align="center">
                    <form class="POST">
                        <input class="input" type="text" placeholder="&#128102;  Nombre" name="nombre" size="20" maxlength="30" style="width:15; font-size:30px;" required autofocus><br><br>
...
<!--Registro de empleado - por administrador -->
<head>
    <script>
        function comprobarClave(){
            password = document.comp.password.value
...
<div class="modal fade" id="admin_employee_registry" role="dialog">
    <div class="modal-dialog">
